            ...
            if (email != null && AccountDAO.checkExistedEmail(email) == null) {
                ...
                Session mySession = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication("QuocVDKSE160940@fpt.edu.vn", "ilzsfkvzactmvpai");
                    }
                });
                try {
                    ...
                    msg.setSubject("PLANT SHOP - VERIFICATION EMAIL");
                ...
                request.getRequestDispatcher("MainController?action=EnterOtpRegister").forward(request, response);
            }
        } catch (Exception e){
            e.printStackTrace();
        }
