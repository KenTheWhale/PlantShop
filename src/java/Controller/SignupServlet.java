    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (pass.equals(repass)) {
                if (AccountDAO.checkExisted(mail, pass) != null) {
                    request.setAttribute("msg", "Account is already existed");
                    ...
                    request.getRequestDispatcher("MainController?action=RegisterEmail").forward(request, response);
                }
            } else {
