        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!customer.isEmpty() && !begindate.isEmpty() && !enddate.isEmpty()) {
                if (!begindate.matches(regex) || !enddate.matches(regex)) {
                    ...
                    listH = OrderDAO.displayDayCustomerFilterA(customer, begindate, enddate);
                }
            } 
            if (!customer.isEmpty() && begindate.isEmpty() && enddate.isEmpty()) {
                listH = OrderDAO.displayCustomerFilterA(customer);
            ...
            if (customer.isEmpty() && !begindate.isEmpty() && !enddate.isEmpty()) {
                if (!begindate.matches(regex) || !enddate.matches(regex)) {
                    ...
                    listH = OrderDAO.displayDayFilterA(begindate, enddate);
            ...
            request.setAttribute("option", "AdOrder");
