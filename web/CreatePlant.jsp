<%-- 
    ...
    Created on : Mar 21, 2023, 5:04:44 AM
    Author     : Admin
--%>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 class="panel-title">Create plant</h3>
                        </div>
                                    ...
                                    <table class="table table-user-information">
                                        <form action="MainController" method="post">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Price</td>
                                                    <td><input type="number" min="0" name="Pprice" required="" ></td>
                                                </tr>
                                                <tr>
                                                    <td>Image path</td>
                                                    <td><input type="text" name="Pimage" required=""></td>
                                                </tr>
                                                <tr>
                                                    <td>Description</td>
                                                ...
                                                <tr>
                                                    <td>Status</td>
                                                    <td>
                                                        <input type="radio" name="Pstatus"  value="In stock"><label>In stock</label><br> 
                                                        <input type="radio" name="Pstatus" value="Out of stock"><label>Out of stock</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Category</td>
                                                    <td>
                                                        ...
                                                        %>
                                                        <input type="radio" name="PCate"  value="<%= c.getId()%>"><label><%= c.getName()%></label><br>
                                                            <%
                                                                }
                                                            %>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="submit" class="btn btn-danger" style=" border: none" value="Create">
                                                        <input type="hidden" style=" border: none" value="PCreate" name="action">
