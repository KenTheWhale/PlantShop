<%-- 
    Document   : EnterOtp
    Created on : Mar 7, 2023, 4:04:15 PM
    Author     : Admin
--%>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="panel-body">
                                        <form id="register-form" action="MainController" role="form" autocomplete="off"
                                            ...
                                            <div class="form-group">
                                                <input style="background-color: green" name="action" class="btn btn-lg btn-primary btn-block" value="Reset Password" type="submit">
                                            </div>
