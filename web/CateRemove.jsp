<%-- 
    Document   : CateRemove
    Created on : Mar 24, 2023, 12:11:01 AM
    Author     : Admin
--%>
        ...
        <div class="container" style="padding-top: 30px">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-10 col-md-offset-1">
                    <h2 style="color: black; text-align: center">Are you sure to delete <span style="color: red"><%= c.getName()%></span></h2>
                    <table class="table table-hover">
                        <tbody>
                            <tr>
                                <td class="col-sm-1 col-md-1" style="padding-left: 350px">
                                    <button type="button" class="btn btn-danger" style="border: none">
                                        <a href="MainController?action=Remove&name=<%= c.getName()%>&ac=CancelC" style="color: white;text-decoration: none">Cancel</a>
                                    </button>
                                    <button type="button" class="btn btn-danger" style="border: none">
                                        <a href="MainController?action=Remove&name=<%= c.getName()%>&ac=RemoveC" style="color: white;text-decoration: none">Remove</a>
                                    </button>
                                </td>
                            </tr>
                        </tbody>
